...
bash "install-system-packages" do
    code <<-EOH
    apt-get install -y python-setuptools libgdal-dev python-pyproj python-pip zlibc python-virtualenv python-dev python-numpy python-matplotlib python-gdal python-scipy 
    ldconfig
    EOH
end
